  ...
  return (
    <div className='h-screen flex items-center justify-center  '>
      <div className='w-5/6  h-1/2  lg:h-4/6 lg:w-11/12 bg-orange-10 -mt-96 lg:-mt-60'>
        ...
        <ReactFlowProvider>{show && <ReactFlow className='mt-24' paneMoveable={true} defaultZoom={zoom} zoomOnPinch={true} elements={elements} onConnect={onConnect} onElementsRemove={onElementsRemove} />}</ReactFlowProvider>
      </div>
    </div>
  );
};
